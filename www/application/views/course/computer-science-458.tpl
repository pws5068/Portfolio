...
<p>The first project of CMPSC 458 required the implementation of a 3-dimensional height map based on the color intensity of each pixel in an image. This map is surrounded by a textured skybox environment which can be rotated freely by the user. Additionally, the viewing user can translate and scale the height map or change to different input images.<br>

<a href="https://github.com/pws5068/OpenGL-Heightmap">Github Repositry</a>
...
<br>
<a href="https://github.com/pws5068/OpenGL-RollerCoaster">Github Repositry</a>

<h3>RayTracer Engine</h3>
<p>The third project of Computer Science 468 was to construct a raytracing engine using OpenGL.  The program must accept an input file describing shapes and their positions/sizes.  Additionally, each shape must be given settings for opacity,luminance,reflectance and refraction to apply to their designated texture image.<br>
<a href="https://github.com/pws5068/OpenGL-RayTracer">Github Repositry</a>
</p>