<h3>Databases</h3>
<p>During the past few years I've prototyped, implemented, and administrated a large number of databases. Despite the experience however, Computer Science 431W is my first formal training on the subject. With the help of a small team, I have developed an online store for Rock Climbing enthusiasts.</p>

<h3>Rock Sport Nation</h3>
